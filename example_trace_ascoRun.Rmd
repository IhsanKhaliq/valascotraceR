...
billa_list <- vector(mode = "list", length = 4)
...
Inspect the severity of the observation quadrats.
...
Plot the increase in disease over space and time as the proportion of infected quadrats.
...
predicted_tosari <- c(0.04, 0.04, 0.48, 0.92, 0.92, 0.92, 0.92, 0.92)
...
# Combine into a single vector
predicted_billa <- c(0, 0.04, 0.04, 0.52, 0.6, 0.8, 0.8, 0.8, 0.8, 0.8)
```
